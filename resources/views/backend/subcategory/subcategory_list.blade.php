               ...
               <div class="card-box">
                    ...
                    <tbody>
                         ...
                         <tr class="gradeA odd" role="row">
                              ...
                              <td class="actions">
                                   <a href="{{route('edit.subcategory',$subcategory->id)}}" class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                   <a href="{{route('delete.subcategory',$subcategory->id)}}" class="on-default remove-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                              </td>
                         </tr>
                         @endforeach
               </tbody>
